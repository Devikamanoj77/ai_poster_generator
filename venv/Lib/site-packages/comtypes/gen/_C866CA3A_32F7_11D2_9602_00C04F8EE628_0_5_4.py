...
__all__ = [
    'SAFT32kHz16BitStereo', 'SREAllEvents', 'SVPAlert',
    'DISPID_SPERetainedStreamOffset', 'SPCATEGORYTYPE',
    'DISPID_SRRAlternates', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SGRInitialState', 'SP_VISEME_5', 'SPSTREAMFORMATTYPE',
    'SPEI_RECO_OTHER_CONTEXT', 'SpeechUserTraining',
    'ISpeechPhraseProperty', 'SPSMF_SAPI_PROPERTIES',
    'SPFM_OPEN_READWRITE', 'SVP_19', 'DISPID_SVSpeakCompleteEvent',
    'DISPIDSPTSI_SelectionOffset', 'SVSFParseAutodetect',
    'DISPID_SLPPhoneIds', 'SPAS_CLOSED', 'SAFT22kHz8BitStereo',
    'ISpeechPhraseInfo', 'eLEXTYPE_APP', 'DISPID_SpeechVoiceEvent',
    'SRESoundEnd', 'SPCS_ENABLED', 'DISPID_SVEAudioLevel',
    'ISpeechPhraseAlternates', 'DISPID_SRRPhraseInfo',
    'DISPID_SpeechPhraseProperty', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechObjectTokenCategory', 'ISpRecoGrammar2',
    'SAFT8kHz16BitMono', 'SAFTADPCM_22kHzMono', 'SPPS_NotOverriden',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SRRTLength',
    'SWPUnknownWordUnpronounceable', 'SPEI_END_SR_STREAM',
    'SpeechCategoryRecognizers', 'DISPID_SRCESoundEnd', 'ISpShortcut',
    'SRARoot', 'eLEXTYPE_VENDORLEXICON', 'SpeechAudioFormatGUIDText',
    'SGDSInactive', 'ISpeechXMLRecoResult', 'SGLexical',
    'DISPID_SVEStreamEnd', 'DISPID_SRAudioInputStream',
    'ISpeechPhraseRule', 'DISPID_SPCIdToPhone', 'DISPID_SFSOpen',
    'DISPID_SASCurrentDevicePosition', 'ISpeechFileStream',
    'DISPID_SOTs_NewEnum', 'SpeechLexiconType',
    'SGDSActiveWithAutoPause', 'SPEI_SOUND_START',
    'SAFTGSM610_11kHzMono', 'DISPID_SPPChildren',
    'ISpeechRecoResult2', 'ISpeechLexiconPronunciation',
    'SpStreamFormatConverter', 'SVP_18', 'SPEI_SOUND_END',
    'DISPID_SPIProperties', 'ISpeechGrammarRuleStateTransition',
    'SECFIgnoreCase', 'SPVOICESTATUS', 'SVP_4', 'eLEXTYPE_PRIVATE11',
    'eLEXTYPE_PRIVATE13', 'SpMemoryStream', 'SAFT44kHz8BitStereo',
    'STCLocalServer', 'SPTEXTSELECTIONINFO',
    'DISPID_SVSInputWordLength', 'SAFTNoAssignedFormat', 'SVP_6',
    'SLTApp', 'DISPID_SPRuleEngineConfidence', 'SAFT22kHz8BitMono',
    'SWPUnknownWordPronounceable', 'SGPronounciation',
    'eLEXTYPE_RESERVED6', 'ISpeechGrammarRules',
    'SAFTADPCM_11kHzMono', 'ISpObjectToken', 'SPEI_END_INPUT_STREAM',
    'SpResourceManager', 'DISPID_SRGIsPronounceable',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SVAudioOutputStream',
    'SPVPRI_NORMAL', 'SpeechAudioProperties', 'SPSLMA', 'SpLexicon',
    ...
    'SVSFPurgeBeforeSpeak', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SVResume', '__MIDL_IWinTypes_0009',
    ...
    'SPAUDIOBUFFERINFO', 'DISPID_SVGetVoices', 'DISPID_SOTRemove',
    'WAVEFORMATEX', 'DISPID_SpeechAudioBufferInfo', 'SVP_7',
    'ISpeechRecoResultTimes', 'DISPID_SRCEStartStream',
    'DISPID_SRRSetTextFeedback', 'DISPID_SWFEBlockAlign', 'SVP_2',
    'SP_VISEME_6', 'SVSFVoiceMask', 'ISpStream', 'SAFT8kHz8BitStereo',
    'DISPID_SLGetPronunciations', 'SAFT16kHz16BitMono',
    'DISPID_SVStatus', 'Speech_Max_Word_Length',
    'DISPID_SRSNumberOfActiveRules', 'SVSFDefault',
    'ISpeechPhoneConverter', 'DISPID_SWFEBitsPerSample',
    'DISPID_SAFSetWaveFormatEx', 'SpeechLoadOption',
    'ISpPhoneticAlphabetConverter', 'DISPID_SRCERequestUI',
    'DISPID_SLPs_NewEnum', 'SGRSTTRule', 'SECFIgnoreWidth',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SpeechGrammarRules',
    'SWTAdded', 'DISPID_SLWType', 'SITooQuiet', 'SPBINARYGRAMMAR',
    'SRTExtendableParse', 'SVP_16', 'DISPID_SRCVoicePurgeEvent',
    'SPSHORTCUTTYPE', 'SAFTADPCM_8kHzStereo', 'ISpObjectWithToken',
    'eLEXTYPE_PRIVATE4', 'SRSInactiveWithPurge', 'SVSFParseSapi',
    'SVP_20', 'SRAExport', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SPPParent', 'SASRun', 'ISpeechAudio',
    'SRERecoOtherContext', 'DISPID_SpeechRecognizer',
    'IInternetSecurityManager', 'ISpeechMMSysAudio', 'DISPID_SVVoice',
    'SECFNoSpecialChars', 'ISpRecoGrammar', 'eWORDTYPE_DELETED',
    'SVP_12', 'SpPhraseInfoBuilder', 'DISPID_SGRSAddWordTransition',
    'SpeechGrammarWordType', 'DISPID_SVAudioOutput',
    'SRADefaultToActive', 'DISPID_SGRSTransitions',
    'DISPID_SpeechPhraseInfo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SDTProperty',
    'SPDKL_LocalMachine', 'DISPID_SLGetWords', 'DISPID_SRStatus',
    'DISPID_SRIsShared', 'SLODynamic', 'STSF_FlagCreate',
    'DISPID_SPAsCount', 'Speech_StreamPos_Asap', 'SPEI_MIN_TTS',
    'SAFTCCITT_uLaw_44kHzMono', 'SPGS_ENABLED', 'SpeechPartOfSpeech',
    'SRAInterpreter', 'DISPID_SGRAddState', 'ISpXMLRecoResult',
    'DISPID_SRCEInterference', 'SREAdaptation',
    'SpeechPropertyLowConfidenceThreshold', 'SVP_11', 'SP_VISEME_8',
    'STCInprocHandler', 'SPEI_START_SR_STREAM', 'SPWORD',
    'DISPID_SPRuleConfidence', 'DISPID_SGRSAddSpecialTransition',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SOTCGetDataKey', 'SPEI_MIN_SR',
    'SPSFunction', 'DISPID_SRGRecoContext', 'eLEXTYPE_PRIVATE10',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechRegistryUserRoot', 'SPSNoun',
    'DISPID_SAFGetWaveFormatEx', 'SVP_10', 'SP_VISEME_19',
    'DISPID_SLAddPronunciation', 'IEnumSpObjectTokens',
    'DISPID_SPAsItem', 'tagSPPROPERTYINFO', 'DISPID_SBSRead',
    'DISPID_SpeechRecognizerStatus', 'SPSEMANTICERRORINFO',
    'SPAR_Unknown', 'SASPause', 'DISPID_SVSLastBookmark',
    'DISPID_SPPsCount', 'SPFM_CREATE_ALWAYS', 'DISPID_SPRs_NewEnum',
    'DISPID_SLPsCount', 'UINT_PTR', 'SPCT_DICTATION',
    'SpObjectTokenCategory', 'SVP_5', 'DISPID_SRGCmdLoadFromMemory',
    'ISpRecoContext2', 'ISpPhraseAlt', 'DISPID_SBSWrite',
    'SDTAlternates', 'DISPID_SVSPhonemeId', 'SPSSuppressWord',
    'SPEI_PHONEME', 'ISpRecognizer', 'DISPID_SLGenerationId',
    'SpNullPhoneConverter', 'SpeechVoicePriority',
    'SpeechTokenShellFolder', 'SREStreamStart', 'SPEI_RESERVED3',
    'Speech_StreamPos_RealTime', 'SVEBookmark', 'SPPS_RESERVED2',
    'SPVPRI_OVER', 'SP_VISEME_4', 'DISPID_SPRuleParent',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRCEHypothesis',
    'SPEI_RESERVED1', 'ISpAudio', 'SWTDeleted', 'DISPID_SPCLangId',
    'IStream', 'SPEI_PHRASE_START', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRRecognizer',
    'DISPID_SpeechPhraseProperties', 'ISpeechLexiconWord',
    'DISPID_SOTGetAttribute', 'SDTDisplayText', 'SGDSActive',
    'SPBO_NONE', 'DISPID_SASState', 'DISPID_SPERequiredConfidence',
    'ISpeechObjectTokenCategory', 'DISPID_SPPsItem',
    'eLEXTYPE_PRIVATE16', 'SGRSTTDictation', 'SPEI_ADAPTATION',
    'SPEI_RESERVED5', 'DISPID_SAStatus', 'DISPID_SPIRule',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SVF_None',
    'SBONone', 'SAFT44kHz8BitMono', 'SPEI_TTS_PRIVATE',
    'SSFMCreateForWrite', 'SAFT8kHz8BitMono', 'SpNotifyTranslator',
    'DISPID_SPISaveToMemory', 'ISpPhrase', 'SpeechVisemeType',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGCmdLoadFromObject',
    'SDA_One_Trailing_Space', 'DISPID_SRSetPropertyString',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SpeechPhraseReplacement', 'LONG_PTR',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPDKL_CurrentUser',
    'DISPID_SRGetFormat', 'SPINTERFERENCE_NONE', 'DISPID_SGRsAdd',
    'DISPID_SGRsItem', 'STCInprocServer', 'ISpEventSource',
    'ISpEventSink', 'DISPID_SRGetPropertyString', 'SSFMOpenForRead',
    ...
    'SREPropertyStringChange', 'DISPID_SOTsCount', 'ISpRecognizer2',
    'SP_VISEME_2', 'SPWORDPRONOUNCEABLE', 'SpCustomStream',
    'SpeechRuleState', 'DISPID_SPRuleId',
    'SpeechStreamSeekPositionType', 'SVEVoiceChange',
    'DISPID_SRGState', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SRRAudioFormat', 'DISPID_SVGetProfiles', 'SpStream',
    'ISpDataKey', 'SpObjectToken', 'DISPID_SpeechRecoResult',
    'SpeechVoiceSpeakFlags', 'SpeechRecoProfileProperties',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SABufferInfo',
    'DISPID_SRCRetainedAudio', 'SSSPTRelativeToEnd', 'SAFTText',
    'DISPID_SpeechPhraseElement', 'DISPID_SVSVisemeId',
    'DISPID_SVEPhoneme', 'ISpRecoResult', 'ISpProperties',
    'SRAImport', 'SPEI_INTERFERENCE', 'SGDisplay',
    'SPPS_SuppressWord', 'DISPID_SPCPhoneToId', 'SVSFUnusedFlags',
    'SPGRAMMARWORDTYPE', 'SPLO_DYNAMIC', 'eLEXTYPE_PRIVATE19',
    'SRTStandard', 'SECNormalConfidence', 'SVP_8', 'SPWF_INPUT',
    'SAFTADPCM_44kHzStereo', 'SPPHRASEREPLACEMENT',
    'SpeechTokenContext', 'SAFT32kHz16BitMono',
    'DISPID_SABIBufferSize', 'SpeechTokenKeyAttributes',
    'ISpeechPhraseProperties', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SPWORDPRONUNCIATIONLIST', 'SRTEmulated', 'SPXMLRESULTOPTIONS',
    'SPEI_RESERVED2', 'SpeechBookmarkOptions', 'DISPID_SVVolume',
    'SSFMOpenReadWrite', 'DISPID_SpeechAudioStatus',
    'eLEXTYPE_PRIVATE7', 'DISPID_SBSFormat',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRsDynamic',
    'SAFT11kHz8BitStereo', 'eLEXTYPE_PRIVATE8',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SVSLastResult',
    'DISPID_SpeechPhraseReplacements',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SPRText',
    'SpeechAllElements', 'DISPID_SLPsItem',
    ...
    'DISPID_SRGCmdSetRuleIdState', 'ISpStreamFormatConverter',
    'SRATopLevel', 'SDTLexicalForm', 'DISPID_SLWLangId',
    'SPSModifier', 'SREPhraseStart', 'SPBO_PAUSE',
    'SpeechRetainedAudioOptions', 'DISPID_SPIReplacements',
    'SPLO_STATIC', 'SPRST_ACTIVE_ALWAYS', 'DISPID_SASetState',
    'ISpeechRecoResult', 'SDA_Consume_Leading_Spaces',
    'DISPID_SVEViseme', 'DISPIDSPTSI_ActiveLength',
    ...
    'DISPID_SDKEnumKeys', 'SPGS_DISABLED', 'SAFTGSM610_22kHzMono',
    'SpeechCategoryAudioIn', 'SAFT16kHz8BitStereo',
    'SAFTCCITT_ALaw_11kHzStereo', 'SDKLDefaultLocation',
    'DISPID_SpeechPhraseElements', 'SVSFIsNotXML',
    'DISPID_SPIElements', 'SPAR_Low', 'DISPID_SASFreeBufferSpace',
    'DISPID_SLPType', 'SpSharedRecognizer', 'DISPID_SRRGetXMLResult',
    'SP_VISEME_14', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRCERecognizerStateChange', 'SVPOver', 'DISPID_SVEWord',
    'SpeechAudioVolume', 'SGSExclusive',
    ...
    'ISpeechObjectToken', 'DISPID_SOTSetId',
    'DISPID_SDKGetStringValue', 'DISPID_SAFGuid',
    'DISPID_SPERetainedSizeBytes', 'SVEWordBoundary', 'SGSDisabled',
    'SPPHRASEELEMENT', 'SpeechAddRemoveWord', 'SLTUser',
    'SAFT32kHz8BitStereo', 'SWPKnownWordPronounceable',
    'SpeechCategoryRecoProfiles', 'SDKLCurrentUser',
    'DISPID_SRRAudio', 'DISPID_SGRSTsItem', 'DISPID_SPEsCount',
    'SAFTCCITT_ALaw_11kHzMono', 'SREPropertyNumChange', 'SVEPrivate',
    'DISPID_SRState', 'SpeechRegistryLocalMachineRoot', 'SPEI_MAX_SR',
    ...
    'SREHypothesis', 'SPINTERFERENCE_TOOQUIET',
    'SAFTCCITT_uLaw_22kHzMono', 'SVP_3', 'SRERecognition',
    'STSF_LocalAppData', 'DISPID_SPRFirstElement',
    'SAFT11kHz16BitStereo', 'SPPHRASE', 'SAFT11kHz16BitMono',
    '_SPAUDIOSTATE', 'SpeechSpecialTransitionType', 'SINone',
    'DISPID_SRCreateRecoContext', 'SPAO_NONE', 'DISPID_SVRate',
    'SpeechDiscardType', 'DISPID_SAVolume', 'SVSFPersistXML',
    'DISPID_SRCEAudioLevel', 'DISPID_SpeechPhraseAlternate',
    'ISpLexicon', 'ISpeechTextSelectionInformation', 'SVP_14',
    '_ISpeechRecoContextEvents', 'DISPID_SRCEEndStream',
    'SRCS_Enabled', 'DISPID_SRGReset', 'SpeechWordPronounceable',
    'eLEXTYPE_PRIVATE9', 'DISPID_SCSBaseStream', 'SPWT_PRONUNCIATION',
    'ISpeechRecoContext', 'SPSInterjection', 'SpeechRecoEvents',
    'SpeechCategoryPhoneConverters', 'SPPS_Noun',
    'SpeechCategoryAudioOut', 'SPAO_RETAIN_AUDIO',
    'SAFTADPCM_22kHzStereo', 'SpeechRecoContextState',
    'SpPhoneConverter', 'SVEPhoneme', 'DISPID_SLGetGenerationChange',
    'DISPID_SGRAttributes', 'eLEXTYPE_PRIVATE6', 'SREStateChange',
    'SAFT22kHz16BitStereo', 'DISPID_SLWsCount', 'SPVPRIORITY',
    'SDA_Two_Trailing_Spaces', 'SRTAutopause', 'SSTTWildcard',
    'DISPID_SOTRemoveStorageFileName', 'SPGS_EXCLUSIVE', 'DISPIDSPRG',
    'DISPID_SWFEExtraData', 'ISpeechPhraseReplacements',
    'DISPID_SRCEPropertyStringChange', 'SPEI_RECO_STATE_CHANGE',
    'SAFT32kHz8BitMono', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEI_MAX_TTS', 'ISpGrammarBuilder', 'SPFM_OPEN_READONLY',
    'DISPID_SPRNumberOfElements', 'ISpRecoCategory',
    'eLEXTYPE_PRIVATE20', 'SPSHT_NotOverriden',
    'DISPID_SGRSTPropertyName', 'SAFT24kHz16BitMono',
    'DISPID_SGRSTPropertyId', 'SPAUDIOSTATUS', 'SECLowConfidence',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SMSGetData',
    'SpeechVoiceCategoryTTSRate', 'SP_VISEME_1',
    'SPINTERFERENCE_NOISE', 'eLEXTYPE_RESERVED9',
    'SPRS_ACTIVE_USER_DELIMITED', 'Speech_Default_Weight',
    'SPRST_ACTIVE', 'SP_VISEME_9', 'SpTextSelectionInformation',
    'DISPID_SMSADeviceId', 'DISPID_SPPs_NewEnum',
    'DISPID_SPRules_NewEnum', 'SPINTERFERENCE',
    'DISPID_SDKDeleteValue', 'ISpeechGrammarRuleState',
    'SVSFNLPSpeakPunc', 'DISPID_SOTsItem',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SpeechRecoResultTimes',
    '_RemotableHandle', 'ISpeechLexicon',
    'DISPID_SRGSetTextSelection', 'DISPID_SOTCId', 'SRTSMLTimeout',
    'SpeechTokenKeyUI', 'DISPID_SGRClear', 'DISPID_SVWaitUntilDone',
    'SPCT_SUB_COMMAND', 'DISPID_SRAudioInput',
    'DISPID_SVEVoiceChange', 'SPINTERFERENCE_TOOFAST',
    'SAFT12kHz16BitStereo', 'SECFEmulateResult', 'SBOPause',
    ...
    'SRSEIsSpeaking', 'SAFTADPCM_11kHzStereo', 'SRSActive',
    'DISPID_SpeechLexiconPronunciation', 'eLEXTYPE_PRIVATE17',
    'DISPID_SRCSetAdaptationData', 'SP_VISEME_15', 'SPSHT_OTHER',
    'SP_VISEME_0', 'SPSHORTCUTPAIR', 'eLEXTYPE_PRIVATE15',
    'DISPID_SVAlertBoundary', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SSTTDictation', 'SVSFlagsAsync', 'DISPID_SGRSTPropertyValue',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SVSkip', 'DISPID_SPRsItem',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpRecoContext',
    'SpeechTokenKeyFiles', 'SpeechRecognizerState',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SRCBookmark', 'SPPROPERTYINFO',
    'eLEXTYPE_RESERVED10', 'SPLOADOPTIONS', 'ISpPhoneConverter',
    ...
    'SP_VISEME_13', 'SpeechGrammarState', 'DISPID_SGRsCount',
    'ISpRecognizer3', 'SP_VISEME_21', 'DISPID_SLRemovePronunciation',
    'DISPID_SPRuleChildren', 'SPRULESTATE', 'ISpeechVoiceStatus',
    'DISPID_SGRs_NewEnum', 'DISPID_SRCEBookmark', 'SAFT24kHz8BitMono',
    'SPFM_NUM_MODES', 'SPCS_DISABLED', 'IInternetSecurityMgrSite',
    'SITooFast', 'SpInprocRecognizer', 'SRSActiveAlways',
    ...
    'SPCT_SLEEP', 'SPEVENTENUM', 'ISpeechCustomStream',
    'SpUnCompressedLexicon', 'SAFTExtendedAudioFormat',
    'SpeechRecognitionType', 'DISPID_SLPLangId',
    'SPWORDPRONUNCIATION', 'DISPID_SPPValue', 'DISPID_SOTDataKey',
    'SAFTGSM610_44kHzMono', 'SpeechGrammarTagDictation',
    'ISpeechRecognizer', 'SPXRO_SML', 'SPEVENT', 'DISPID_SPIGetText',
    'ISpeechDataKey', 'SPCT_SUB_DICTATION', 'DISPID_SVIsUISupported',
    'SpMMAudioOut', 'DISPID_SWFESamplesPerSec', 'DISPID_SPACommit',
    'SLOStatic', 'ISpeechWaveFormatEx', 'SINoSignal',
    'DISPID_SRGDictationLoad', 'SPSNotOverriden',
    'DISPID_SRCESoundStart', 'DISPID_SRSAudioStatus',
    'DISPID_SPEsItem', 'DISPID_SVSpeakStream', 'DISPID_SPILanguageId',
    'DISPID_SPPFirstElement', 'DISPID_SLWsItem',
    'DISPID_SRGetRecognizers', 'DISPID_SRCState', 'SVP_21',
    'DISPID_SPRuleName', 'SAFT16kHz16BitStereo',
    'DISPID_SPAs_NewEnum', 'SPEI_SR_PRIVATE', 'DISPID_SLPSymbolic',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPIAudioSizeBytes',
    'SP_VISEME_18', 'DISPID_SPPBRestorePhraseFromMemory',
    'SSFMCreate', 'SPVISEMES', 'SVEStartInputStream',
    'SPRST_INACTIVE', 'ISpSerializeState', 'SPPS_RESERVED4',
    'SAFTNonStandardFormat', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpStreamFormat', 'SPSMF_SRGS_SAPIPROPERTIES', 'SVSFParseMask',
    'SP_VISEME_3', 'DISPID_SpeechObjectToken',
    ...
    'SpeechRunState', 'DISPID_SVSpeak', 'DISPID_SpeechLexicon',
    'SpeechDisplayAttributes', 'SPEI_SR_BOOKMARK',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SGRSAddRuleTransition',
    'DISPID_SRGCmdLoadFromResource', 'SVP_9', 'SAFT12kHz8BitStereo',
    'SPRS_INACTIVE', 'SPBO_TIME_UNITS', 'eLEXTYPE_RESERVED7',
    'DISPID_SRCVoice', 'DISPID_SRGId', 'DISPID_SPRulesItem',
    'DISPID_SpeechPhraseRules', 'DISPID_SRGCommit', 'SpShortcut',
    'DISPID_SOTCategory', 'ISpeechMemoryStream',
    'ISpeechPhraseElements', 'ISpeechPhraseRules',
    'DISPID_SRCERecognition', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SOTDisplayUI',
    'SP_VISEME_11', 'SPPS_Verb', '_ISpeechVoiceEvents',
    'SPSHORTCUTPAIRLIST', 'DISPID_SGRSTType', 'SRAONone',
    'DISPID_SpeechAudio', 'SDTReplacement', 'DISPID_SPIEngineId',
    'eWORDTYPE_ADDED', 'ISpeechVoice', 'SAFT24kHz16BitStereo',
    'DISPID_SpeechCustomStream', 'SECFDefault',
    'DISPID_SADefaultFormat', 'SPSERIALIZEDRESULT',
    'SDTPronunciation', 'SREFalseRecognition',
    'SPADAPTATIONRELEVANCE', 'SpeechGrammarTagWildcard',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpNotifySource',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCRequestedUIType',
    'SRADynamic', 'DISPID_SDKSetStringValue', 'IEnumString',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPIDSPTSI',
    'DISPID_SpeechFileStream', 'SPPHRASERULE',
    'DISPID_SOTIsUISupported', 'tagSTATSTG', 'SAFT12kHz8BitMono',
    'DISPID_SPEActualConfidence', 'SpWaveFormatEx',
    'SpeechPropertyResourceUsage', 'DISPID_SRCEventInterests',
    'DISPID_SPRDisplayAttributes', 'DISPID_SGRSTsCount', 'SDTAll',
    'DISPID_SMSAMMHandle', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPVPRI_ALERT', 'DISPID_SOTCSetId', 'SDTAudio',
    'SPINTERFERENCE_TOOSLOW', 'SAFTTrueSpeech_8kHz1BitMono',
    'SpeechVoiceEvents', 'DISPID_SVGetAudioInputs',
    'SPSEMANTICFORMAT', 'DISPID_SVDisplayUI', 'SpeechVisemeFeature',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SFSClose', 'SPPS_RESERVED1',
    'DISPID_SRSetPropertyNumber', 'SGRSTTWord', 'SP_VISEME_20',
    'SpeechRuleAttributes', 'SPFM_CREATE', 'DISPID_SDKDeleteKey',
    'eLEXTYPE_RESERVED8', 'SPSMF_UPS', 'DISPID_SPRuleFirstElement',
    'DISPID_SGRSTNextState', 'SP_VISEME_12',
    'DISPID_SVEventInterests', 'SPEI_UNDEFINED',
    'DISPID_SRGDictationSetState', 'SAFT16kHz8BitMono',
    'DISPID_SRCPause', 'DISPID_SBSSeek', 'ISpeechPhraseInfoBuilder',
    'DISPID_SPIEnginePrivateData', 'SVESentenceBoundary',
    'SPFILEMODE', 'ISpNotifyTranslator', 'eLEXTYPE_PRIVATE3',
    'SAFTCCITT_uLaw_11kHzMono', 'SVP_15',
    'SpeechPropertyResponseSpeed', 'DISPID_SWFEFormatTag',
    'SVSFIsXML', 'SpeechEngineConfidence', 'DISPID_SRRTTickCount',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SpeechRecoResult2',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SPPS_LMA',
    'SRCS_Disabled', 'SPCONTEXTSTATE', 'SAFT44kHz16BitMono',
    'DISPID_SRSCurrentStreamNumber', 'SPEI_FALSE_RECOGNITION',
    'SPRECOSTATE', 'DISPID_SWFEChannels',
    'DISPID_SLRemovePronunciationByPhoneIds', 'ISpVoice',
    'SP_VISEME_17', 'ISpNotifySink', 'ISpeechGrammarRule',
    'DISPID_SPIRetainedSizeBytes', 'SPWF_SRENGINE',
    'DISPID_SGRSTRule', 'SAFTCCITT_uLaw_8kHzStereo', 'SPWT_DISPLAY',
    'SINoise', 'DISPID_SpeechObjectTokens',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechVoice',
    'SSTTTextBuffer', 'DISPID_SOTGetStorageFileName',
    'SPAUDIOOPTIONS', 'SECFIgnoreKanaType', 'SpeechMicTraining',
    'SGRSTTEpsilon', 'DISPID_SVGetAudioOutputs', 'SITooLoud',
    'SVEAudioLevel', 'SREStreamEnd', 'SPSVerb', 'DISPID_SGRId',
    'DISPID_SGRSTText', 'SFTInput', 'DISPID_SDKSetBinaryValue',
    'ISpeechBaseStream', 'SVEAllEvents', 'DISPID_SRRGetXMLErrorInfo',
    'SPRULE', 'SPDKL_CurrentConfig', 'SVSFNLPMask',
    'SPEVENTSOURCEINFO', 'SPEI_RECOGNITION',
    'DISPID_SDKGetBinaryValue', 'SPBO_AHEAD', 'SGRSTTWildcard',
    'ISpeechRecognizerStatus', 'DISPID_SpeechDataKey', 'SPAR_High',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_PRIVATE12',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPEs_NewEnum', 'SpMMAudioIn',
    'SpeechTokenIdUserLexicon', 'DISPID_SPIGrammarId',
    'SREInterference', 'ISpObjectTokenCategory',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SGDSActiveUserDelimited', 'STSF_AppData', 'DISPID_SPPName',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SpeechLexiconProns',
    'SVSFParseSsml', 'SP_VISEME_7', 'SPAS_RUN', 'DISPID_SRCResume',
    'DISPID_SOTMatchesAttributes', 'DISPID_SpeechMemoryStream',
    'DISPID_SPANumberOfElementsInResult', 'SSSPTRelativeToStart',
    'ISpeechPhraseElement', 'SDTRule', 'ISpeechPhraseAlternate',
    'ISpeechLexiconWords', 'SPSHT_EMAIL', 'SP_VISEME_16',
    'SAFT24kHz8BitStereo', 'SAFTCCITT_ALaw_8kHzStereo',
    'ISequentialStream', 'SVEViseme', 'SpeechEmulationCompareFlags',
    'SPEI_REQUEST_UI', 'SRESoundStart', 'SpeechStreamFileMode',
    'SPRECOGNIZERSTATUS', 'eLEXTYPE_PRIVATE14', 'SAFTADPCM_8kHzMono',
    'DISPID_SAFType', 'DISPID_SLWs_NewEnum',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'eLEXTYPE_PRIVATE2',
    'DISPID_SVEEnginePrivate', 'SPRS_ACTIVE', 'SpVoice',
    'ISpeechLexiconPronunciations', 'SVP_17', 'DISPID_SRRTStreamTime',
    'DISPID_SPAStartElementInResult', 'SpAudioFormat',
    'DISPID_SAEventHandle', 'DISPID_SMSALineId',
    'DISPID_SPRulesCount', 'SpeechFormatType', 'SPEI_VISEME',
    'DISPID_SPRsCount', 'SASStop', 'SPPS_Modifier',
    'SpeechCategoryAppLexicons', 'SASClosed', 'SpeechAudioState',
    'STCAll', 'SPCT_COMMAND', 'DISPID_SLPPartOfSpeech',
    'DISPID_SGRSTWeight', 'SPPHRASEPROPERTY', 'DISPID_SVEBookmark',
    'DISPID_SRCEAdaptation', 'SPWORDTYPE',
    'DISPID_SRGDictationUnload', 'DISPID_SPIGetDisplayAttributes',
    'SVSFIsFilename', 'SRSInactive', 'SPEI_WORD_BOUNDARY',
    'SpSharedRecoContext', 'SPPS_Noncontent', 'DISPID_SGRsCommit',
    'DISPID_SpeechGrammarRule', 'DISPID_SRGRules',
    'SpeechPropertyComplexResponseSpeed', 'SPAS_STOP',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SRTReSent',
    'SpCompressedLexicon', 'SAFT44kHz16BitStereo', 'SREBookmark',
    'DISPID_SOTCDefault', 'SAFT48kHz8BitMono',
    'ISpeechRecoResultDispatch', 'DISPID_SVSInputWordPosition',
    'DISPID_SDKOpenKey', 'SpMMAudioEnum', 'DISPID_SLWWord',
    'DISPID_SPARecoResult', 'eLEXTYPE_PRIVATE1', 'SRSEDone',
    'SPWT_LEXICAL', 'DISPID_SRRTOffsetFromStart', 'DISPID_SVPriority',
    'DISPID_SVSLastStreamNumberQueued', 'SAFT12kHz16BitMono',
    'ISpeechRecoGrammar', 'DISPID_SPEAudioStreamOffset',
    'ISpeechAudioStatus', 'SFTSREngine', 'SREPrivate',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVPause', 'SVF_Stressed',
    'SPPS_Interjection', 'DISPID_SGRSRule', 'STSF_CommonAppData',
    'SPDATAKEYLOCATION', 'SPPS_RESERVED3', 'DISPID_SLWPronunciations',
    'SRERequestUI', 'SAFT48kHz16BitStereo',
    'DISPID_SPPNumberOfElements', 'ISpResourceManager',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRRSpeakAudio',
    'DISPID_SPEDisplayText', 'SREAudioLevel', 'SP_VISEME_10',
    'DISPID_SDKEnumValues', 'SPBOOKMARKOPTIONS', 'SVPNormal',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'Speech_Max_Pron_Length',
    'SPPARTOFSPEECH', 'SPEI_HYPOTHESIS', 'SPEI_VOICE_CHANGE',
    'SVF_Emphasis', 'SpeechInterference', 'DISPID_SDKGetlongValue',
    'SpeechTokenValueCLSID', 'DISPID_SPPEngineConfidence',
    'SGRSTTTextBuffer', 'SpFileStream', 'DISPID_SRRTimes',
    'DISPID_SPEDisplayAttributes', 'SAFT48kHz16BitMono',
    'SPRECORESULTTIMES', 'eLEXTYPE_PRIVATE5',
    'DISPID_SpeechVoiceStatus', 'SAFTGSM610_8kHzMono',
    'DISPID_SDKCreateKey', 'SpeechGrammarTagUnlimitedDictation',
    'SPAS_PAUSE', 'SpeechDictationTopicSpelling', 'SRAORetainAudio',
    'SPLEXICONTYPE', 'DISPID_SPELexicalForm',
    'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_1',
    'STCRemoteServer', 'DISPID_SPEEngineConfidence', 'ISpMMSysAudio',
    'DISPID_SRCRecognizer', 'SVP_0', 'DISPID_SREmulateRecognition',
    'SPSHT_Unknown', 'DISPID_SRSClsidEngine', 'SITooSlow',
    'DISPID_SRCEPhraseStart', 'SpeechWordType', 'SGSEnabled',
    'SPXRO_Alternates_SML', 'DISPID_SPEAudioTimeOffset',
    'ISpeechAudioBufferInfo', 'SPWORDLIST',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_RESERVED4',
    'SAFT22kHz16BitMono', 'ISpeechObjectTokens',
    'DISPID_SPIStartTime', 'SAFTCCITT_ALaw_22kHzMono',
    'SPPS_Function', 'SPSUnknown', 'DISPID_SRRRecoContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SPGRAMMARSTATE',
    'SDKLCurrentConfig', 'SDA_No_Trailing_Space', 'SPAUDIOSTATE',
    'ISpeechResourceLoader', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRDisplayUI', 'SpPhoneticAlphabetConverter',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SOTId',
    'eLEXTYPE_PRIVATE18', 'DISPID_SPIAudioStreamPosition', 'SVP_13',
    'DISPID_SGRName', 'DISPID_SOTCreateInstance', 'SPPS_Unknown',
    'SAFTADPCM_44kHzMono'
]

_check_version('1.2.0', 1697472424.111956)
